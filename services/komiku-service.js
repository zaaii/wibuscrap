...
module.exports.getMangaByGenre = async (req, res) => {
  const page = req.query.page || 1;
  const keyword = req.query.s;
  ...
  if (keyword) {
    ...
    c.queue(`https://data.komiku.id/other/hot/?genre2=${param}`);
  } else {
    c.queue(`https://data.komiku.id/other/hot/page/${page}/?genre2=${param}`);
  }
};
